...
<center>
<div id="menu1">
<a href="index.php"><IMG src="upload/Refresh.png" width="50" height="50">Home</a>
		<form id="form1" name="form1" method="post" action="chkregistration.php" onSubmit="return validate()">		
			<table width="522" border="0">
			  <tr align="left" bgcolor="#CCFFFF">
			    <th height="29" colspan="2" scope="row"><u>Personel Information</u></th>
		      </tr>
			  <tr>
			    <th width="170" height="33" scope="row">First Name</th>
			    <td width="247">
			      <label for="lname"></label>
			      <input name="fname" type="text" id="fname" size="35"   onBlur="validate()"/>
		        </td>
		      </tr>
			  <tr>
			    <th height="37" scope="row">Last Name
			      <label for="lname"></label></th>
			    <td><input name="lname" type="text" id="lname" size="35"  onBlur="validate()" /></td>
		      </tr>
			  <tr>
           ...
           <th height="37" scope="row">
			    ...
			    <td><input type="text" name="bdate"id="bdate" readonly="yes"> </td>
                  ...
                  <tr>
			    <th width="170" height="33" scope="row">username</th>
			    <td width="247">
			      <label for="username"></label>
			      <input name="username" type="text" id="username" size="35"   onBlur="validate()"/>
		        </td>
		      </tr>
			  ...
			  <tr>
			    ...
			    <td><input name="zipcode" type="text" id="zipcode" size="35"  onBlur="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/></td>
		                 </tr>
			  <tr>
			    <th height="37" scope="row">Phone No</th>
			    <td><label for="date"></label>
		        <input name="phone" type="text" id="phone" size="35"  onBlur="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/></td>
		      </tr>
			  <tr>
			    <th scope="row">Mobile No</th>
			    <td><label for="mobile"></label>
		        <input name="mobile" type="text" id="mobile" size="35"  onBlur="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/></td>
		      </tr>
			  <tr>
			    <th scope="row">&nbsp;</th>
